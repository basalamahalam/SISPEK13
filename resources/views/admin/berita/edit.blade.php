...
<section class="ml-0 lg:ml-[250px] p-8">
    <a href="/berita-admin" class="flex items-center font-semibold text-lg text-primary mb-10 hover:text-sky-800 transition-all duration-300 ease-in-out">
    ...
    <h2 class="text-sky-800 font-small text-lg mb-10">Edit Berita</h2>
    <form action="/berita-admin/{{ $berita->slug }}" method="POST" enctype="multipart/form-data" class="max-w mx-auto">
        @method('put')
        @csrf
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            @if ($berita->image)
            <img src="{{ asset('storage/' . $berita->image) }}" class="img-preview max-w-sm mb-3 col-sm-5 d-block">
            @else

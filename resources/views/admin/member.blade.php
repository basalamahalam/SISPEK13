...
<section class="ml-0 lg:ml-[250px] p-8">
    ...
    <a href="/anggota-{{ $name }}/{{ $slug }}/create" class="text-sm font-semibold text-white bg-primary py-3 px-6 rounded-md hover:shadow-lg hover:opacity-50 transition duration-300 ease-in-out">+ Tambah Anggota</a>
        ...
        <div class="inline-block min-w-full overflow-hidden">
            ...
            <table class="min-w-full mb-0">
                ...
                <tr>
                    ...
                    <th scope="col" class="text-sm font-medium px-4 py-2">Kelas</th>
                    <th scope="col" class="text-sm font-medium px-4 py-2">Instagram</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b bg-gray-100">
                        ...
                        <td class="text-sm font-normal px-4 py-2 whitespace-nowrap text-left text-gray-500">{{ $member->nama_anggota }}</td>
                        <td class="text-sm font-normal px-4 py-2 whitespace-nowrap text-left text-gray-500">{{ $member->kelas }}</td>
                        <td class="text-sm font-normal px-4 py-2 whitespace-nowrap text-left text-gray-500">{{ $member->instagram_anggota }}</td>
                        <td class="text-sm font-normal px-4 py-2 whitespace-nowrap text-right">
                            <a href="/anggota-{{ $name }}/{{ $slug }}/{{ $member->id }}/edit" class="font-medium text-blue-600 hover:text-blue-700 focus:text-blue-700 active:text-blue-800 transition duration-300 ease-in-out">Edit</a>

...
<section class="ml-0 lg:ml-[250px] p-8">
    <a href="/anggota-{{ $org }}/{{ $slug }}" class="flex items-center font-semibold text-lg text-primary mb-10 hover:text-sky-800 transition-all duration-300 ease-in-out">
    ...
    <h2 class="text-sky-800 font-small text-lg mb-10">Input Anggota {{ $name }}</h2>
    <form action="/anggota-{{ $org }}/{{ $slug }}" method="POST" enctype="multipart/form-data" class="max-w mx-auto">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="text" class="bg-gray-300 rounded-md block w-1/2 p-2 @error('nama_anggota') border-red-500 @enderror" id="nama_anggota" name="nama_anggota" value="{{ old('nama_anggota') }}" required autofocus>
            @error('nama_anggota')
        ...
        <div class="mb-6">
            ...
            <input type="file" class="block w-1/2 border cursor-pointer bg-gray-300 border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 disabled:opacity-50 disabled:pointer-events-none
                ...
                file:py-3 file:px-4 @error('gambar_anggota') border-red-500 @enderror" id="gambar_anggota" name="gambar_anggota" onchange="previewImage()" required>
        ...
        <div class="mb-6">
            ...
            <input type="text" class="bg-gray-300 rounded-md block w-1/2 p-2 @error('instagram_anggota') border-red-500 @enderror" id="instagram_anggota" name="instagram_anggota" value="{{ old('instagram_anggota') }}" required autofocus>

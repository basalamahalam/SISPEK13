...
<section class="ml-0 lg:ml-[250px] p-8">
    ...
    <h2 class="text-sky-800 font-small text-lg mb-10">Input Jurnal</h2>
    <form action="/jurnal-admin" method="POST" enctype="multipart/form-data" class="max-w mx-auto">
        @csrf
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <input type="text" class="bg-gray-300 rounded-md block w-1/2 p-2 @error('author') border-red-500 @enderror" id="author" name="author" value="{{ old('author') }}" required autofocus>
            @error('author')
                <p class="text-red-500 mt-2">{{ $message }}</p>
            @enderror
        </div>

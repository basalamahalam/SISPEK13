...
class AdminOSISController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.profil', [
            'title' => 'PROFIL OSIS',
            'name' => 'osis',
            'data'=> Organization::where('nama_organisasi', 'osis')->latest()->get(),
            'div'=> Division::where('organization_id', 1)->get(),
            ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/profil-osis')->with('success', 'New Organization has been added!');
    } 
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/profil-osis')->with('success', 'Organization has been updated!');
    }

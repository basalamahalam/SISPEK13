...
class AdminDivMPKController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/profil-mpk')->with('success', 'New Division has been added!');
    }
    ...
    public function update(Request $request, $slug)
    {
        ...
        return redirect('/profil-mpk')->with('success', 'Division has been updated!');
    }

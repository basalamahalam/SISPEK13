...
!(function (t, e) {
        ...
        m = function (t) {
            ...
            const a = e || d,
                ...
                u = function (t) {
                    ...
                    const e = b(t.target, { matchingSelector: l });
                    null != e &&
        ...
        O = {
            ...
            pickFiles(t) {
                ...
                e.addEventListener("change", () => {
                    ...
                    y(document.getElementById(this.fileInputId)),
    ...
    class V {
        static proxyMethod(t) {
            const { name: e, toMethod: i, toProperty: n, optional: r } = z(t);
            this.prototype[e] = function () {
                ...
                return r
                    ? ((t = null === (a = o) || void 0 === a ? void 0 : a[e]),
                      t ? _.call(t, o, arguments) : void 0)
                    : ((t = o[e]), _.call(t, o, arguments));
            };
        }
    }
    const z = function (t) {
    ...
    const X =
            1 ===
            (null === (J = Array.from) || void 0 === J
                ? void 0
                : J.call(Array, "👼").length),
        Y =
            null !=
            (null === (K = " ".codePointAt) || void 0 === K
                ? void 0
                : K.call(" ", 0)),
        Q =
            " 👼" ===
    ...
    const nt = function () {
        ...
        st = (function () {
            const t = S("input", { dir: "auto", name: "x", dirName: "x.dir" }),
                e = S("form");
            e.appendChild(t);
            const i = (function () {
                    try {
    ...
    const ht = () => (at || (at = pt().concat(gt())), at),
        ...
        xt = { "application/x-trix-feature-detection": "test" },
        yt = function (t) {
        ...
        Ct = /Mac|^iP/.test(navigator.platform)
            ? (t) => t.metaKey
            : (t) => t.ctrlKey,
        Rt = (t) => setTimeout(t, 1),
        St = function () {
    ...
    const Bt = (t, e) =>
            (null == t ? void 0 : t.startContainer) ===
                (null == e ? void 0 : e.startContainer) &&
            (null == t ? void 0 : t.startOffset) ===
                (null == e ? void 0 : e.startOffset) &&
            (null == t ? void 0 : t.endContainer) ===
                (null == e ? void 0 : e.endContainer) &&
            (null == t ? void 0 : t.endOffset) ===
                (null == e ? void 0 : e.endOffset),
        Pt = new Ft(),
        It = function () {
        ...
        Nt = function () {
            var t;
            const e =
                null === (t = It()) || void 0 === t ? void 0 : t.getRangeAt(0);
            if (e && !Mt(e)) return e;
        },
        Ot = function (t) {
        ...
        Wt = (t) =>
            t
                .replace(new RegExp("".concat(c), "g"), "")
                .replace(new RegExp("".concat(u), "g"), " "),
        qt = new RegExp("[^\\S".concat(u, "]")),
        Ut = (t) =>
            t
                .replace(new RegExp("".concat(qt.source), "g"), " ")
                .replace(/\ {2,}/g, " "),
        Vt = function (t, e) {
    ...
    class de extends ee {
        ...
        createNodes() {
            ...
            if (this.block.isEmpty()) t.push(S("br"));
                ...
                var e;
                const i =
                        null === (e = dt(this.block.getLastAttribute())) ||
                        void 0 === e
                            ? void 0
                            : e.text,
                ...
                t.push(...Array.from(n.getNodes() || [])),
                    this.shouldAddExtraNewlineElement() && t.push(S("br"));
            }
            if (this.attributes.length) return t;
            {
                ...
                const r = S({ tagName: i, attributes: e });
        ...
        createContainerElement(t) {
            ...
            return S({ tagName: r, className: i, attributes: e });
        }
    ...
    class ge extends ee {
        ...
        didSync() {
            return (
                ...
                Rt(() => this.garbageCollectCachedViews())
            );
        }
        ...
        function n(e, i) {
            try {
                var o = t[e](i),
                    s = o.value,
                    a = s instanceof be;
                Promise.resolve(a ? s.wrapped : s).then(
                    function (t) {
                        a
                            ? n("return" === e ? "return" : "next", t)
                            : r(o.done ? "return" : "normal", t);
                    },
                    function (t) {
                        n("throw", t);
                    }
    ...
    class Ce extends it {
        ...
        isPreviewable() {
            return this.attributes.has("previewable")
                ...
                : Ce.previewablePattern.test(this.getContentType());
        }
        getType() {
    ...
    Ae(Re, "permittedAttributes", ["caption", "presentation"]),
        xe.registerType("attachment", Re);
    class Se extends xe {
        static fromJSON(t) {
    ...
    class Ee extends it {
        ...
        splitObjectsAtRange(t) {
            let e,
                [i, n, r] = this.splitObjectAtPosition(Le(t));
            return (
        ...
        isEqualTo(t) {
            return (
                super.isEqualTo(...arguments) ||
                ke(this.objects, null == t ? void 0 : t.objects)
            );
        }
        contentsForInspection() {
            return {
    ...
    class Te extends it {
        ...
        isEqualTo(t) {
            return (
                ...
                (this.text.isEqualTo(null == t ? void 0 : t.text) &&
                    nt(this.attributes, null == t ? void 0 : t.attributes))
            );
        }
        copyWithText(t) {
        ...
        isListItem() {
            var t;
            return null === (t = dt(this.getLastAttribute())) || void 0 === t
                ? void 0
                : t.listAttribute;
        }
        isTerminalBlock() {
    ...
    class qe extends it {
        ...
        insertDocumentAtRange(t, e) {
            ...
            return (
                Lt(e) && a.isEmpty() && !a.hasAttributes()
        ...
        insertBlockBreakAtRange(t) {
            ...
            return (
                0 === n && (e = [new Te()]),
                new this.constructor(
                    r.blockList.insertSplittableListAtPosition(new Ee(e), i)
                )
            );
        }
        ...
        toConsole() {
            return JSON.stringify(this.blockList.toArray()).map((t) =>
                JSON.parse(t.text.toConsole())
            );
        }
    }
    const Ue = function (t) {
    ...
    class He extends V {
        ...
        constructor(t) {
            let {
                ...
                : {};
            super(...arguments),
                (this.allowedAttributes = e || Ve),
                (this.forbiddenProtocols = i || ze),
                (this.forbiddenElements = n || _e),
                (this.body = Je(t));
        }
        sanitize() {
        ...
        Ke = function (t) {
            let e =
                arguments.length > 1 && void 0 !== arguments[1]
                    ...
                    : {};
            const i = "string";
            return { string: (t = Wt(t)), attributes: e, type: i };
        },
        Ge = (t, e) => {
            try {
    ...
    class $e extends V {
        ...
        parse() {
            try {
                ...
                const e = C(this.containerElement, { usingFilter: Ze });
        ...
        appendBlockForElement(t) {
            ...
            if (e && !this.isBlockElement(t.firstChild)) {
                if (
                    ...
                    if (t.firstChild) {
                        if (i && nt(e, this.currentBlock.attributes))
                            return this.appendStringWithAttributes("\n");
                        (this.currentBlock =
    ...
    var li = Object.freeze({ __proto__: null });
    class ci extends V {
        constructor(t, e) {
            super(...arguments),
    ...
    ci.proxyMethod("attachment.getAttribute"),
        ci.proxyMethod("attachment.hasAttribute"),
        ci.proxyMethod("attachment.setAttribute"),
        ci.proxyMethod("attachment.getAttributes"),
        ci.proxyMethod("attachment.setAttributes"),
        ci.proxyMethod("attachment.isPending"),
        ci.proxyMethod("attachment.isPreviewable"),
        ci.proxyMethod("attachment.getURL"),
        ci.proxyMethod("attachment.getHref"),
        ci.proxyMethod("attachment.getFilename"),
        ci.proxyMethod("attachment.getFilesize"),
        ci.proxyMethod("attachment.getFormattedFilesize"),
        ci.proxyMethod("attachment.getExtension"),
        ci.proxyMethod("attachment.getContentType"),
        ci.proxyMethod("attachment.getFile"),
        ci.proxyMethod("attachment.setFile"),
        ci.proxyMethod("attachment.releaseFile"),
        ci.proxyMethod("attachment.getUploadProgress"),
        ci.proxyMethod("attachment.setUploadProgress");
    class ui extends V {
        constructor() {
            let t =
                arguments.length > 0 && void 0 !== arguments[0]
        ...
        manageAttachment(t) {
            return (
                this.managedAttachments[t.id] ||
                    (this.managedAttachments[t.id] = new ci(this, t)),
                this.managedAttachments[t.id]
            );
        }
    ...
    class di extends V {
        ...
        setTextAttribute(t, e) {
            ...
            if ("href" === t) {
                const t = we.textForStringWithAttributes(e, { href: e });
        ...
        canIncreaseNestingLevel() {
            ...
            if (e) {
                if (
                    null === (t = dt(e.getLastNestableAttribute())) ||
                    void 0 === t ||
                    !t.listAttribute
                )
        ...
        updateCurrentAttributes() {
            ...
            if (t) {
                ...
                if (
                    (Array.from(ht()).forEach((t) => {
                        e[t] || this.canSetCurrentAttribute(t) || (e[t] = !1);
                    }),
                    !Et(e, this.currentAttributes))
                )
                    return (
    ...
    di.proxyMethod("getSelectionManager().getPointRange"),
        di.proxyMethod("getSelectionManager().setLocationRangeFromPointRange"),
        di.proxyMethod("getSelectionManager().createLocationRangeFromDOMRange"),
        di.proxyMethod("getSelectionManager().locationIsCursorTarget"),
        di.proxyMethod("getSelectionManager().selectionIsExpanded"),
        di.proxyMethod("delegate?.getSelectionManager");
    class gi extends V {
        constructor(t) {
            super(...arguments),
                (this.composition = t),
    ...
    class Ai {
        constructor(t, e, i) {
            (this.insertFiles = this.insertFiles.bind(this)),
                ...
                (this.element = i),
                (this.undoManager = new gi(this.composition)),
                (this.filters = vi.slice(0));
        }
        loadDocument(t) {
    ...
    class xi {
        ...
        findLocationFromContainerAndOffset(t, e) {
            ...
            const a = C(this.element, { usingFilter: Si });
            for (; a.nextNode(); ) {
        ...
        getSignificantNodesForIndex(t) {
            const e = [],
                i = C(this.element, { usingFilter: Ci });
            let n = !1;
            for (; i.nextNode(); ) {
    ...
    const yi = function (t) {
        ...
        Ci = function (t) {
            return Ri(t) === NodeFilter.FILTER_ACCEPT
                ? Si(t)
                : NodeFilter.FILTER_REJECT;
        },
        Ri = function (t) {
    ...
    class ki extends V {
        constructor(t) {
            super(...arguments),
                ...
                (this.element = t),
                (this.locationMapper = new xi(this.element)),
                (this.pointMapper = new Ei()),
                (this.lockCount = 0),
                m("mousedown", {
        ...
        pauseTemporarily() {
            ...
            const e = () => {
                    if (
                        ...
                        A(document, this.element))
                    )
                        return this.selectionDidChange();
                },
                i = setTimeout(e, 200);
            t = ["mousemove", "keydown"].map((t) =>
                m(t, { onElement: document, withCallback: e })
            );
        }
        selectionDidChange() {
            if (!this.paused && !v(this.element))
        ...
        updateCurrentLocationRange(t) {
            ...
            if (
                ...
                !Dt(t, this.currentLocationRange)
            )
                return (
        ...
        domRangeWithinElement(t) {
            return t.collapsed
                ? A(this.element, t.startContainer)
                : A(this.element, t.startContainer) &&
                      A(this.element, t.endContainer);
        }
    }
    ki.proxyMethod("locationMapper.findLocationFromContainerAndOffset"),
        ki.proxyMethod("locationMapper.findContainerAndOffsetFromLocation"),
        ki.proxyMethod("locationMapper.findNodeAndOffsetFromLocation"),
        ki.proxyMethod("pointMapper.createDOMRangeFromPoint"),
        ki.proxyMethod("pointMapper.getClientRectsForDOMRange");
    var Li = Object.freeze({
        ...
        Di = Object.freeze({ __proto__: null });
    const { lang: wi, css: Ti, keyNames: Fi } = U,
        Bi = function (t) {
            return function () {
                            ...
                            this.attachment.isPreviewable() &&
                                t.appendChild(
                                    S({
                                        tagName: "div",
                                        className:
                                            Ti.attachmentMetadataContainer,
                                        childNodes: S({
                                            tagName: "span",
                ...
                Ae(
                    ...
                    Bi(() => {
                        const t = S({
                            ...
                            attributes: { placeholder: wi.captionPlaceholder },
                            data: { trixMutable: !0 },
                        });
                        ...
                        m("input", { onElement: t, withCallback: i }),
                            m("input", {
                                onElement: t,
    ...
    class Ii extends V {
        ...
        didClickAttachment(t, e) {
            ...
            const r = this.findAttachmentForElement(e),
                o = !!b(t.target, { matchingSelector: "figcaption" });
    ...
    class Wi extends V {
        ...
        nodeIsMutable(t) {
            return b(t, { matchingSelector: Mi });
        }
    ...
    class Vi extends V {
        constructor(t) {
            super(...arguments),
                (this.element = t),
                (this.mutationObserver = new Wi(this.element)),
    ...
    var zi;
    Ae(Vi, "events", {});
    const { browser: _i, keyNames: Hi } = U;
    let Ji = 0;
    class Ki extends Vi {
        constructor() {
        ...
        getPastedHTMLUsingHiddenElement(t) {
            const e = this.getSelectedRange(),
                ...
                n = S({ style: i, tagName: "div", editable: !0 });
            return (
    ...
    Ae(Ki, "events", {
        ...
        paste(t) {
            ...
            if (n) {
                ...
                if (t) {
                    ...
                    !t.name &&
                        e &&
                        (t.name = "pasted-file-".concat(++Ji, ".").concat(e)),
                        (i.type = "File"),
                        (i.file = t),
        ...
        Ki.proxyMethod("responder?.getSelectedRange"),
        Ki.proxyMethod("responder?.setSelectedRange"),
        Ki.proxyMethod("responder?.expandSelectionInDirection"),
        Ki.proxyMethod("responder?.selectionIsInCursorTarget"),
        Ki.proxyMethod("responder?.selectionIsExpanded");
    const Gi = (t) => {
            var e, i;
        ...
        Xi = function (t) {
            if (t.key && $i && t.key.codePointAt(0) === t.keyCode) return t.key;
            {
                ...
                if (
                    ...
                    return $.fromCodepoints([e]).toString();
            }
        },
        Yi = function (t) {
    ...
    Qi.proxyMethod("inputController.setInputSummary"),
        Qi.proxyMethod("inputController.requestRender"),
        Qi.proxyMethod("inputController.requestReparse"),
        Qi.proxyMethod("responder?.selectionIsExpanded"),
        Qi.proxyMethod("responder?.insertPlaceholder"),
        Qi.proxyMethod("responder?.selectPlaceholder"),
        Qi.proxyMethod("responder?.forgetPlaceholder");
    class Zi extends Vi {
        constructor() {
    ...
    class bn extends V {
        ...
        didClickDialogButton(t, e) {
            const i = b(e, { matchingSelector: un });
        ...
        eachActionButton(t) {
            return Array.from(this.element.querySelectorAll(ln)).map((e) =>
                t(e, pn(e))
            );
        }
        updateAttributes(t) {
        ...
        eachAttributeButton(t) {
            return Array.from(this.element.querySelectorAll(an)).map((e) =>
                t(e, fn(e))
            );
        }
        applyKeyboardCommand(t) {
            ...
            for (const t of Array.from(
                ...
                if (JSON.stringify(i.sort()) === e)
                    return p("mousedown", { onElement: t }), !0;
            }
            return !1;
        }
        dialogIsVisible(t) {
    ...
    class vn extends Ni {
        constructor(t) {
            ...
            super(...arguments),
                ...
                (this.selectionManager = new ki(this.editorElement)),
                (this.selectionManager.delegate = this),
                (this.composition = new di()),
                (this.composition.delegate = this),
                (this.attachmentManager = new ui(
                ...
                (this.compositionController = new Ii(
                    this.editorElement,
                    this.composition
                )),
                (this.compositionController.delegate = this),
                (this.toolbarController = new bn(
        ...
        locationRangeDidChange(t) {
            return (
                ...
                this.updateCurrentActions(),
                this.attachmentLocationRange &&
                    !Dt(this.attachmentLocationRange, t) &&
        ...
        runEditorFilters() {
            ...
            if (
                ...
                !Dt(e.selectedRange, i.selectedRange) ||
    ...
    Ae(vn, "actions", {
        ...
        vn.proxyMethod("getSelectionManager().setLocationRange"),
        vn.proxyMethod("getSelectionManager().getLocationRange");
    ...
    const Sn = function (t) {
            if (!t.hasAttribute("contenteditable"))
                return (
                    ...
                    })("focus", { onElement: t, withCallback: () => En(t) })
                );
        },
        En = function (t) {
            return kn(t), Ln(t);
        ...
        kn = function (t) {
            ...
            if (
                ...
                return (
                    ...
                    m("mscontrolselect", { onElement: t, preventDefault: !0 })
                );
        },
        Ln = function (t) {
            var e, i;
    ...
    class wn extends HTMLElement {
        get trixId() {
            return this.hasAttribute("trix-id")
                ...
                : (this.setAttribute("trix-id", ++Rn), this.trixId);
        }
        get labels() {
            const t = [];
            this.id &&
            ...
            const e = b(this, { matchingSelector: "label" });
        ...
        get inputElement() {
            ...
            if (this.parentNode) {
                ...
                const e = S("input", { type: "hidden", id: t });
                return (
        ...
        notify(t, e) {
            if (this.editorController)
                return p("trix-".concat(t), { onElement: this, attributes: e });
        }
        ...
        connectedCallback() {
            this.hasAttribute("data-trix-internal") ||
                ...
                (function (t) {
                    ...
                    e(), m("focus", { onElement: t, withCallback: e });
                })(this),
                this.editorController ||
                    (p("trix-before-initialize", { onElement: this }),
                    (this.editorController = new vn({
                        editorElement: this,
                        html: (this.defaultValue = this.value),
                    })),
                    requestAnimationFrame(() =>
                        p("trix-initialize", { onElement: this })
                    )),
        ...
        clickBubbled(t) {
            ...
            const e = b(t.target, { matchingSelector: "label" });
    ...
    return (
        ...
        setTimeout(function () {
            customElements.get("trix-toolbar") ||
                customElements.define("trix-toolbar", Cn),
                customElements.get("trix-editor") ||
                    customElements.define("trix-editor", wn);
        }, 0),
        Tn
    );
});
